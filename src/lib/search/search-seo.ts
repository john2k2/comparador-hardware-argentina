...
const CATEGORY_SEO_COPY: Record<HardwareCategory, CategorySeoCopy> = {
  'procesadores': {
    ...
    description: 'Compará precios de procesadores AMD Ryzen e Intel Core en Argentina, revisá stock, diferencias entre comercios y enlaces directos para comprar mejor.',
    heading: 'Comparador de precios de procesadores en Argentina',
    intro: 'Explora CPUs AMD Ryzen e Intel Core con valores actualizados, diferencias entre tiendas y opciones para armar o mejorar tu PC sin pagar de mas. Esta categoría sirve para comparar gamas de entrada, modelos para gaming, chips con gráficos integrados y procesadores orientados a productividad. Revisá siempre compatibilidad con motherboard, memoria y refrigeración antes de decidir, porque el costo final del upgrade depende del conjunto completo y no solo del micro elegido.',
  },
  'tarjetas-graficas': {
    title: 'Placas de video en Argentina',
    description: 'Compará precios de placas de video NVIDIA GeForce RTX y AMD Radeon RX en tiendas argentinas, con stock, diferencias y enlaces directos a cada comercio.',
    heading: 'Comparador de precios de tarjetas graficas en Argentina',
    intro: 'Revisa GPUs GeForce y Radeon con stock y ofertas comparadas entre tiendas argentinas para encontrar la mejor opcion para gaming, streaming o trabajo. Además de mirar el importe final, conviene validar memoria VRAM, consumo, tamaño físico, garantía, fuente recomendada y rendimiento esperado para tu monitor. Esta landing ayuda a separar modelos similares, detectar variantes convenientes y evitar compras apuradas cuando distintas tiendas publican placas con nombres muy parecidos.',
  },
  'motherboards': {
    title: 'Motherboards en Argentina',
    description: 'Compará precios de motherboards AMD e Intel en Argentina, revisá disponibilidad por tienda y encontrá opciones convenientes para armar o actualizar tu PC.',
    heading: 'Comparador de precios de motherboards en Argentina',
    intro: 'Encuentra placas madre para plataformas AMD e Intel comparando disponibilidad y alternativas en distintas tiendas del pais. Antes de elegir, revisá socket, chipset, tamaño, soporte de memoria, ranuras M.2, conectividad, fases de alimentación y actualizaciones de BIOS. Una motherboard barata puede ser suficiente para una PC simple, pero una configuración exigente necesita mejores prestaciones para sostener procesadores potentes, almacenamiento rápido y futuras ampliaciones sin quedar limitada.',
  },
  'memoria-ram': {
    title: 'Memoria RAM en Argentina',
    description: 'Compará precios de memoria RAM DDR4 y DDR5 en tiendas argentinas, revisá stock, capacidades y alternativas para actualizar tu computadora.',
    heading: 'Comparador de precios de memoria RAM en Argentina',
    intro: 'Busca modulos DDR4 y DDR5 con ofertas comparadas entre tiendas argentinas para actualizar tu PC con mejor costo y disponibilidad. Mirá capacidad, frecuencia, latencias, cantidad de módulos y compatibilidad con tu plataforma antes de comprar. Para gaming suele convenir priorizar kits dual channel equilibrados, mientras que edición, virtualización o trabajo pesado pueden necesitar más capacidad total. Esta página ayuda a filtrar opciones repetidas y encontrar alternativas razonables.',
  },
  'almacenamiento': {
    title: 'SSD y discos en Argentina',
    description: 'Compará precios de SSD NVMe, SATA y discos rígidos en Argentina, con disponibilidad por tienda y enlaces directos para decidir mejor.',
    heading: 'Comparador de precios de almacenamiento en Argentina',
    intro: 'Compara SSD SATA, NVMe y discos HDD entre distintas tiendas para elegir almacenamiento segun capacidad, velocidad y presupuesto. Un NVMe rápido mejora cargas y transferencias, pero un SATA o HDD todavía puede servir para bibliotecas grandes, backups o equipos económicos. Revisá formato, interfaz, garantía, TBW y espacio real necesario. La mejor compra suele combinar unidad principal veloz con almacenamiento secundario amplio y confiable.',
  },
  'fuentes-alimentacion': {
    title: 'Fuentes de PC en Argentina',
    description: 'Compará precios de fuentes de alimentación para PC en Argentina, revisá potencia, disponibilidad y opciones de tiendas para comprar con más contexto.',
  ...
  'gabinetes': {
    ...
    description: 'Compará precios de gabinetes para PC gamer y oficina en Argentina, revisá stock y enlaces de tiendas para elegir el formato más conveniente.',
  ...
  'refrigeracion': {
    ...
    description: 'Compará precios de coolers CPU, ventiladores y watercooling para PC en Argentina, con stock por tienda y referencias útiles antes de comprar.',
    heading: 'Comparador de precios de refrigeracion para PC en Argentina',
    intro: 'Compara soluciones de aire y liquido para mantener tu PC fria, revisando opciones reales en tiendas argentinas. Antes de elegir, considerá socket compatible, altura disponible, tamaño del radiador, ruido, mantenimiento y capacidad térmica del procesador. Un cooler adecuado evita thermal throttling, mejora estabilidad y puede extender la vida útil del equipo. Para builds compactas o CPUs exigentes, la compatibilidad física es tan importante como el rendimiento anunciado.',
  },
  'perifericos': {
    title: 'Periféricos en Argentina',
    description: 'Compará precios de mouse, teclados, auriculares, monitores y periféricos en Argentina, revisando disponibilidad y enlaces directos a tiendas.',
    heading: 'Comparador de precios de perifericos en Argentina',
    intro: 'Busca mouse, teclados, auriculares, monitores y otros periféricos comparando valores reales entre múltiples tiendas argentinas. En estos productos importan ergonomía, tipo de uso, conectividad, garantía y preferencias personales. Un teclado mecánico, un mouse liviano o un monitor con buena tasa de refresco pueden cambiar mucho la experiencia diaria. Esta sección ayuda a explorar alternativas sin depender de una sola tienda o de nombres comerciales confusos.',
  },
};
